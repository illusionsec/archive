...
if len(sys.argv) < 2:
    ...
    print '[!] Protocols: chargen, ntp, quake, ssdp, ldap, dns, snmp, mdns, tftp, portmap, netbios, stun, dvr'
    print '[!] Output syntax variables: [space], [ip], [bytes]'
    print 'Updated By TempSecurity >3'
    sys.exit()
...
chargen = 'A'
dvr = '\xFF\x00'
stun = '\x00\x01\x00\x00\x21\x12\xA4\x42\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'
natpmp = '\x00\x00'
afs = '\x00\x00\x03\xe7\x00\x00\x00\x00\x00\x00\x00\x65\x00\x00\x00\x00\x00\x00\x00\x00\x0d\x05\x00\x00\x00\x00\x00\x00\x00'
...
dns = '\x45\x67\x01\x00\x00\x01\x00\x00\x00\x00\x00\x01\x02\x73\x6c\x00\x00\xff\x00\x01\x00\x00\x29\xff\xff\x00\x00\x00\x00\x00\x00'
